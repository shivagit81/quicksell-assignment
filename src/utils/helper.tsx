...
export const getPriorityIcon = (priority: string) => {
    switch (priority) {
        ...
        case "Urgent": return <BsExclamationSquareFill color='#fc7840' size={14} />
        default: return <BsExclamationSquareFill color='#fc7840' size={14} />
    }
}
...
export const getStatusIcon = (priority: string) => {
    switch (priority) {
        ...
        case "Done": return <IoCheckmarkCircle color='#5e6ad2' size={16} />
